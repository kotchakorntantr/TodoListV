...
<template>
  ...
  <li class="hover:bg-blue-300 bg-amber-400">
    ...
    <div class="max-w-md mx-auto mt-10 p-6 bg-white rounded-xl shadow-lg space-y-4">
    ...
    <!-- Task List -->
    <ul class="space-y-2">
      <li v-for="task in tasks" :key="task.id" class="flex justify-between items-center p-2 border rounded-md bg-gray-50">
        <div
